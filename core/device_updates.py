from core.models import Controller, Device, DeviceBattery, DeviceDescription, Sensor, SensorValue
...
def full_update(user, controllers):
    for controller in controllers:
        try:
            controller_model = Controller.objects.get(owner=user, name=controller['name'])
        except Controller.DoesNotExist:
            controller_model = Controller.objects.create(owner=user, name=controller['name'])
