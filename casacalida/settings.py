"""
Django settings for casacalida project.
...
SESSION_COOKIE_SECURE = os.environ.get('DJANGO_SECURE', 'true').lower() == 'true'
...
WSGI_APPLICATION = 'casacalida.wsgi.application'
